            ...
            <div class="pcoded-inner-content">
                <div class="main-body">
                    <div class="page-wrapper">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-12">
                                        <div class="page-header-title d-flex justify-content-between">
                                            <h4 class="m-b-10">Recent Forms</h4>
                        ...
                        <div class="row">
                            <?php
                            $query = mysqli_query($connect, "SELECT * FROM forms WHERE user_id='$user_id' ORDER BY form_id DESC LIMIT 3");
                                        ...
                                        <div class="card">
                                            <div class="card-body d-flex justify-content-between">
                                                ...
                                                <div>
                                                    ...
                                                    <a href="../process/delete.php?table=forms&form_id=<?php echo $id; ?>&url=dashboard" title="Delete" class="pull-right"><i class="feather icon-trash-2 text-danger"></i></a>
                                                </div>
                                            </div>
                                        </div>
                                    </a>
